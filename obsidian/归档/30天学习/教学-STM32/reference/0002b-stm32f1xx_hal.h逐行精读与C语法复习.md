...
> 本笔记是 [[归档/30天学习/教学-STM32/lessons/0002-CubeMX工程结构解剖-DianDengMaster逐文件精读|0002 课]] 的附属阅读材料：把 HAL 库总入口头文件 **逐行拆开**，所有注释翻译成中文，所有 C 语法点批注在源码旁边。
...
- 上一课：[[归档/30天学习/教学-STM32/lessons/0002-CubeMX工程结构解剖-DianDengMaster逐文件精读|0002 工程结构解剖]]
...
- 今日进度：[[归档/30天学习/每日日志/每日日志|每日日志索引]]
- 索引：[[归档/30天学习/30天学习 Index|30天学习 Index]]
