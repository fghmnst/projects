...
> 前置：[[归档/30天学习/教学-STM32/lessons/0001-工具链闭环与LED闪烁|0001 工具链闭环与 LED 闪烁]]（已能编译+烧录）
...
> 收录标准：本课出现的每个专业术语，一条**详细解释**（定义 + 类比 + 本工程落点）。已入 [[归档/30天学习/教学-STM32/reference/术语表|课程术语表]] 的标 📖。
...
- 上一课：[[归档/30天学习/教学-STM32/lessons/0001-工具链闭环与LED闪烁|0001 工具链闭环与 LED 闪烁]]
- 下一课：[[归档/30天学习/教学-STM32/learning-records/0003-里程碑记录-点灯到双舵机|0003 里程碑记录（PWM 舵机课程未产出）]]（SG90 转角 = 脉宽映射）
- 术语表：[[归档/30天学习/教学-STM32/reference/术语表|STM32 课程术语表]]
- 任务书：[[归档/30天学习/教学-STM32/MISSION|Mission]]
- 速查表：[[归档/30天学习/教学-STM32/reference/0001-工具链速查|工具链速查表]]
- 今日进度：[[归档/30天学习/每日日志/2026-08-11|2026-08-11 每日日志]]
